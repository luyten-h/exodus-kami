...
public class KamiGUI extends GUI {
    ...
    public static final CFontRenderer cFontRenderer = new CFontRenderer(new Font("Arial", 0, 18), true, true);
    public Theme theme;
        ...
        */
        ...
        friendLabel.addTickListener(() -> {
            ...
            if (OnlineFriends.getFriends().isEmpty()) {
                ...
                friendLabel.addLine("The Goons");
                for (Entity e : OnlineFriends.getFriends()) {
                    friendLabel.addLine(e.getName());
                }
            }
        });
