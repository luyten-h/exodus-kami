...
import me.zeroeightsix.kami.util.SuperIdentifier
...
@Module.Info(
        ...
        description = "Kill your enemies with melee weapons"
)
class Aura : Module() {
    ...
    private val superonly = register(Settings.b("32k Only", false))
    ...
    private val autoTool = register(Settings.b("Auto Weapon", false))
    ...
    override fun onUpdate() {
        ...
        if (superonly.getValue())
        {
            if (!SuperIdentifier.Is32k(mc.player.getHeldItemMainhand()))
                return
        }
