...
@Module.Info(
        name = "BedAura",
        description = "Automatically right clicks beds in range",
...
public class BedAura extends Module {
    ...
    public void onUpdate() {
        ...
        if (mc.player.dimension != 0) {
            ...
            MessageSendHelper.sendErrorMessage(getChatName() + "Exploding beds only works in the nether and in the end, disabling!");
            disable();
        }
    }
}