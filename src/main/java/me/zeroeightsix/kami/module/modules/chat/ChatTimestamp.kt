...
class ChatTimestamp : Module() {
    private val firstColour = register(Settings.e<ColourCode>("First Colour", ColourCode.DARK_RED))
    private val secondColour = register(Settings.e<ColourCode>("Second Colour", ColourCode.DARK_RED))
    ...
    val formattedTime: String
        get() = "§2<" + TimeUtil.getFinalTime(setToText(secondColour.value), setToText(firstColour.value), timeUnitSetting.value, timeTypeSetting.value, doLocale.value) + TextFormatting.RESET + "§2>&r "
