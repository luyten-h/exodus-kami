...
class BreakingWarning : Module() {
    ...
    override fun onRender() {
        ...
        val text = "Your feet are being mined by $playerName!"
        val renderer = Wrapper.getFontRenderer()
        val divider = DisplayGuiScreen.getScale()

        renderer.drawStringWithShadow(mc.displayWidth / divider / 2 - renderer.getStringWidth(text) / 2, mc.displayHeight / divider / 2 - 16, 0, 240, 0, text)
    }
