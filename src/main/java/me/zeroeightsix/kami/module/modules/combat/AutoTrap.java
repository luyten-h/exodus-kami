...
@Module.Info(
        name = "AutoTrap",
        description = "Trap your enemies in Obsidian",
...
public class AutoTrap extends Module {
    ...
    public void onUpdate() {
        ...
        if (firstRun) {
            ...
            if (announceUsage.getValue()) {
                MessageSendHelper.sendChatMessage("The target is now:&a " + lastTickTargetName);
            }
    ...
    private boolean placeBlockInRange(BlockPos pos, double range) {
        ...
        EnumFacing side = OldBIH.getPlaceableSide(pos);
