...
class Tracers : Module() {
    ...
    private val r = register(Settings.integerBuilder("Red").withMinimum(0).withValue(0).withMaximum(255).withVisibility { customColours.value }.build())
    private val g = register(Settings.integerBuilder("Green").withMinimum(0).withValue(214).withMaximum(255).withVisibility { customColours.value }.build())
    private val b = register(Settings.integerBuilder("Blue").withMinimum(0).withValue(0).withMaximum(255).withVisibility { customColours.value }.build())
