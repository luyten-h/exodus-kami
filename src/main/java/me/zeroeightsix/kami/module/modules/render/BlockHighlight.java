...
import me.zeroeightsix.kami.util.OldKamiTessellator;
...
public class BlockHighlight extends Module
{
    ...
    public BlockHighlight() {
        ...
        this.width = this.register((Setting<Float>)Settings.floatBuilder("Width").withRange(1.0f, 10.0f).withValue(1.0f).build());
    }
    ...
    public void onWorldRender(final RenderEvent event) {
        ...
        if (ray.typeOfHit == RayTraceResult.Type.BLOCK) {
            ...
            if (iblockstate.getMaterial() != Material.AIR && mc.world.getWorldBorder().contains(blockpos)) {
                ...
                OldKamiTessellator.drawBoundingBox(iblockstate.getSelectedBoundingBox((World)mc.world, blockpos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), this.width.getValue(), (int)this.red.getValue(), (int)this.green.getValue(), (int)this.blue.getValue(), (int)this.alpha.getValue());
            }
        }
    }
