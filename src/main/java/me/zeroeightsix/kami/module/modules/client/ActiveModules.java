...
public class ActiveModules extends Module {
    ...
    public Setting<Mode> mode = register(Settings.e("Mode", Mode.INFO_OVERLAY));
    ...
    public Setting<String> gui = register(Settings.s("Gui", "165,102,139"));
    public Setting<String> colors = register(Settings.s("Colors", "165,102,139"));
    ...
    private TextFormatting infoGetSetting(boolean isOne) {
        Colours colours = (Colours) MODULE_MANAGER.getModule(Colours.class);
        if (isOne) return setToText(colours.firstColour.getValue());
        else return setToText(colours.firstColour.getValue());
